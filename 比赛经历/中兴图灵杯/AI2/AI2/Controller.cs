...
namespace AI2
{
    ...
    public class Controller : HackerInterface.IControl
    {
        ...
        public void make_choice(Hacker hacker, int[] map_info)
        {
            ...
            //如果没有钥匙 就先去获取钥匙
            int? mykey_index = hacker.GetHackerKey(2);//AI2 是 2号吧？
        ...
        public void Update(Hacker hacker)
        {
            ...
            //bool success = Get_Remove(hacker, map_info, 0, 0);

            //if (hacker.HackerPosition(3) != null)
            //{
            //    logger.info(hacker.HackerPosition(3));
            //}
            //else
            //{
            //    logger.info("null");

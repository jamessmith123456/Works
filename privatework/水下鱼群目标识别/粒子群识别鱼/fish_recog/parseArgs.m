...
%
%       [c,ls,lw,sf] = internal.stats.getargs(pnames,dflts,varargin{:})
%       % On return, sf = [false true true]
%
%       varargin = {'linew' 2 'linestyle' ':' 'special' 99}
%       [c,ls,lw,sf,ex] = internal.stats.getargs(pnames,dflts,varargin{:})
%       % On return, ex = {'special' 99}

%   Copyright 2010-2011 The MathWorks, Inc.
%   $Revision: 1.1.6.3 $  $Date: 2011/07/20 00:09:01 $

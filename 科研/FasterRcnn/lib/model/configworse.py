...
# Minibatch size (number of regions of interest [ROIs]) minibatch size
__C.TRAIN.BATCH_SIZE = 64

# Fraction of minibatch that is labeled foreground (i.e. class > 0)
__C.TRAIN.FG_FRACTION = 0.4 #0.25
...
__C.TRAIN.PROPOSAL_METHOD = 'selective_search' #'gt'
...
__C.TEST.PROPOSAL_METHOD = 'selective_search' #'gt'
